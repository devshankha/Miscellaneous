//This is the famous rotten oranges problem, code is taken from geekforgeeks
//the code is here -https://www.geeksforgeeks.org/minimum-time-required-so-that-all-oranges-become-rotten/
			...
			while (!isDelim(Q.peek())) {
				...
				if (isValid(temp.x + 1, temp.y) && arr[temp.x + 1][temp.y] == 1) {
					if (!flag) {
						...
						//this is used to track the time frame
						ans++;
						flag = true;
					}
