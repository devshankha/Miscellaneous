...
//the code has been taken from geekforgeeks==https://www.geeksforgeeks.org/snake-ladder-problem-2/
/**
 *Given a snake and ladder board, find the minimum number of dice throws required to reach the destination or 
 *last cell from source or 1st cell. Basically, the player has total control over outcome of dice throw and
...
public class SnakesLadder {
	...
	static class qentry {
		int v;// Vertex number
		int dist;// Distance of this vertex from source actually 
		//number of times dice has to be rolled to reach position v
	}
